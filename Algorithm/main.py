...
#              "%s, %s, %s, %s)"
        ...
        row_file = open(f"{targetFile}/row.txt", "r")
        row = row_file.readlines()
        numLayer_file = open(f"{targetFile}/numLayer.txt", "r")
        numLayer = numLayer_file.readlines()
        colorMap_file = open(f"{targetFile}/colorMap.txt", "r")
        colorMap = colorMap_file.read()
        layerMatrix_file = open(f"{targetFile}/layerMatrix.txt", "r")
        layerMatrix = layerMatrix_file.read()
