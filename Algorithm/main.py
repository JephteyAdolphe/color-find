...
class Algorithm:
=======
# Algo v2 with layering that is seperated even if color is similar. includes kmeans (T(Kmeans + 3idArr + 4idMap))
class Algorithm_v2:
>>>>>>> Stashed changes
...
plt.show()
'''
results1 = results_of_algorithm(Algorithm_v2, trials= 1)
'''
